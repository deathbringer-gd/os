...
void init_interupts(void) {
    for (int i = 0; i < 256; i++) {
        idt_set_gate(i, (uint32_t)default_interupt_handler); //TODO: sets every interupt to default_interupt_handler. In the future this needs updating for specific interupts. 
    }
